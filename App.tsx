...
// Confirmed via the build 66/67/68 tests that neither Sentry.init() nor the
// double Sentry.wrap() were the launch-crash cause — that was a broken JS
// bundling script (fixed separately). Safe to re-enable.
Sentry.init({
